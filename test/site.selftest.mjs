...
check("Grove keeps its outer gutter solid instead of leaking the page banner", /\.network-page::before\s*\{\s*content:\s*none;\s*\}/.test(groveCss) && !/shade-tree-banner\.webp/.test(groveCss));
