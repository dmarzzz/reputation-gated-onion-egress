...
check("Grove dashboard stays inside the signed aggregate contract", ["data-node-count", "data-snapshot-state", "data-network", "data-view-time", "data-snapshot-cadence", "data-history-low", "data-history-high", "data-history-samples", "data-history-coverage", "data-relay-row", "data-relay-value", "data-relay-coverage"].every((field) => grovePage.includes(field)) && !/data-view-age|data-node-hours|data-change|Observed changes?|sessions|throughput|latency|bandwidth|success rate|reputation band/i.test(grovePage));
